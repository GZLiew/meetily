            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className="p-2 rounded-lg transition-colors duration-150 hover:bg-blue-100 dark:hover:bg-blue-900/40 bg-blue-50 dark:bg-blue-950/40"
                >
        ...
        >
          {item.type === 'folder' ? (
            ...
            <div className="flex flex-col w-full">
                ...
                {isMeetingItem && (
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
                    <button
                      ...
                      className="hover:text-blue-600 p-1 rounded-md hover:bg-blue-50 dark:hover:bg-blue-950/40 flex-shrink-0"
                    ...
                    <button
                      ...
                      className="hover:text-red-600 p-1 rounded-md hover:bg-red-50 dark:hover:bg-red-950/40 flex-shrink-0"
              ...
              {hasTranscriptMatch && (
                <div className="mt-1 ml-8 text-xs text-muted-foreground bg-yellow-50 dark:bg-yellow-950/40 p-1.5 rounded border border-yellow-100 dark:border-yellow-900/50 line-clamp-2">
        ...
        {!isCollapsed && (
          ...
          <div className="flex-shrink-0 p-2 border-t border-border">
            ...
            {betaFeatures.importAndRetranscribe && (
              <button
                onClick={() => openImportDialog()}
                className="w-full flex items-center justify-center px-3 py-2 mt-1 text-sm font-medium text-foreground bg-blue-100 dark:bg-blue-900/40 hover:bg-blue-200 dark:hover:bg-blue-800/50 rounded-lg transition-colors shadow-sm"
              >
