...
export function BluetoothPlaybackWarning({
  ...
  return (
    <Alert
      className="mb-4 border-yellow-500 bg-yellow-50 dark:bg-yellow-950/40 text-yellow-900 dark:text-yellow-200"
      role="alert"
      aria-live="polite"
    >
      ...
      <div className="flex items-start justify-between w-full">
        <div className="flex-1">
          <AlertTitle className="text-yellow-900 dark:text-yellow-200 font-semibold">
        ...
        <Button
          ...
          className="ml-4 h-6 w-6 text-yellow-700 dark:text-yellow-300 hover:text-yellow-900 dark:hover:text-yellow-100 hover:bg-yellow-100 dark:hover:bg-yellow-900/40"
