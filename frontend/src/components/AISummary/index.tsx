...
export const AISummary = ({ summary, status, error, onSummaryChange, onRegenerateSummary, meeting }: Props) => {
  ...
  const renderErrorState = () => (
    <div className="w-full p-4 bg-red-50 dark:bg-red-950/40 border border-red-200 rounded-lg">
  ...
  const renderLoadingState = () => (
    <div className="w-full p-4 bg-blue-50 dark:bg-blue-950/40 border border-blue-200 rounded-lg">
