  ...
  return (
    <TooltipProvider>
      <div className="flex flex-col space-y-2">
                        ...
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center ${isPausing || isResuming || isStopping
                              ...
                              : 'bg-card border-2 border-border text-muted-foreground hover:border-muted-foreground/50 hover:bg-muted/50'
        ...
        {/* Device error alert */}
        {deviceError && (
          <Alert variant="destructive" className="mt-4 border-red-300 dark:border-red-900/50 bg-red-50 dark:bg-red-950/40">
