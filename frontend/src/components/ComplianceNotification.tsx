    ...
    >
      <div className="bg-popover text-popover-foreground border border-border rounded-lg shadow-lg p-3">
        ...
        <div className="mb-2">
          ...
          <div className="bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-900/50 rounded p-1">
        ...
        <div className="flex gap-1">
          ...
          <Button
            ...
            className="text-xs px-2 py-0.5 h-6 bg-green-600 hover:bg-green-700 text-white flex-1"
          >
