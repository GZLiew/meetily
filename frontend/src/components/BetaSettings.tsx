...
export function BetaSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 p-4 bg-yellow-50 dark:bg-yellow-950/40 border border-yellow-200 dark:border-yellow-900/50 rounded-lg">
      ...
      {/* Info Box */}
      <div className="p-4 bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/50 rounded-lg">
