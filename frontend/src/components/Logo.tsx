  ...
  return (
    <Dialog aria-describedby={undefined}>
      {isCollapsed ? (
        ...
        <DialogTrigger asChild>
          <span className="text-lg text-center border rounded-full bg-blue-50 dark:bg-blue-950/40 border-white font-semibold text-foreground mb-2 block items-center cursor-pointer hover:opacity-80 transition-opacity">
            <span>Meetily</span>
          </span>
        </DialogTrigger>
      )}
