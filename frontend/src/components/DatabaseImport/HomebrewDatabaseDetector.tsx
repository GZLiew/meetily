    ...
    <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-950/40 border-2 border-blue-300 dark:border-blue-800 rounded-lg">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="bg-white/50 dark:bg-white/5 rounded p-2 mb-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleNo}
              disabled={isImporting}
              className="flex-1 px-4 py-2 border-2 border-blue-400 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/40 disabled:bg-muted disabled:cursor-not-allowed transition-colors"
            >
              No, Browse Manually
            </button>
          </div>
