    ...
    <ButtonGroup>
      ...
      {isGenerating ? (
        <Button
          variant="outline"
          size="sm"
          className="bg-gradient-to-r from-red-50 to-orange-50 hover:from-red-100 hover:to-orange-100 border-red-200 dark:from-red-950/40 dark:to-orange-950/40 dark:hover:from-red-900/50 dark:hover:to-orange-900/50 dark:border-red-900/50 xl:px-4"
          onClick={() => {
        ...
        <Button
          variant="outline"
          size="sm"
          className="bg-gradient-to-r from-blue-50 to-purple-50 hover:from-blue-100 hover:to-purple-100 border-blue-200 dark:from-blue-950/40 dark:to-purple-950/40 dark:hover:from-blue-900/50 dark:hover:to-purple-900/50 dark:border-blue-900/50 xl:px-4"
          onClick={() => {
